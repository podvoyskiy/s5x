...
pub mod buffer {
    ...
    pub const PROXY: usize = 8192;
    pub const HTTP_CHUNK: usize = 1024;
    pub const STACK_PACKET: usize = 512;
    pub const TCP_STACK: usize = 65536;
    pub const DNS_UDP: usize = DEFAULT;
    pub const VIRTUAL_MTU: usize = 9000;
}